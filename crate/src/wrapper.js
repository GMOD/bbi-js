...
export async function decompressAndParseBigBed(
  inputs,
  inputOffsets,
  inputLengths,
  blockFileOffsets,
  ...
  await init()
  const packed = bg.decompress_and_parse_bigbed(
    inputs,
    inputOffsets,
    inputLengths,
    blockFileOffsets,
...
export async function parseBigBedBlocks(
  inputs,
  inputOffsets,
  inputLengths,
  blockFileOffsets,
  ...
  await init()
  const packed = bg.parse_bigbed_blocks(
    inputs,
    inputOffsets,
    inputLengths,
    blockFileOffsets,
