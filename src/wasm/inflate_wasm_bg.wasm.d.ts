...
export const decompress_and_parse_bigbed: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => void;
...
export const parse_bigbed_blocks: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => void;
export const parse_bigwig_block: (a: number, b: number, c: number, d: number, e: number) => void;
export const parse_bigwig_blocks: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
export const parse_summary_block: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const parse_summary_blocks: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => void;
